...
bool IOEvent::isWriting() { return events & writeEventFlag; }
bool IOEvent::isReading() { return events & writeEventFlag; }
int IOEvent::getFd() { return eventFd; }
uint32_t IOEvent::getEvents() { return events; }

void IOEvent::setReadFunc(const DefaultFunction &func) { readHandle = func; }
void IOEvent::setWriteFunc(const DefaultFunction &func) { writeHandle = func; }
void IOEvent::setErrorFunc(const DefaultFunction &func) { errorHandle = func; }
void IOEvent::setCloseFunc(const DefaultFunction &func) { closeHandle = func; }
void IOEvent::update() { eventLoop->modifyEvent(eventFd); }

void IOEvent::removeFromLoop() { eventLoop->removeEvent(eventFd); }
