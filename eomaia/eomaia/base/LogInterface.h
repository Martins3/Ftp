...
public:
  ...
  void registerInterface(LogInterface *handle) {
    handle_ = handle;
    funcs_[Debug] =
        std::bind(&LogInterface::debug, handle_, std::placeholders::_1);
    funcs_[Info] =
        std::bind(&LogInterface::info, handle_, std::placeholders::_1);
    funcs_[Warn] =
        std::bind(&LogInterface::warn, handle_, std::placeholders::_1);
    funcs_[Error] =
        std::bind(&LogInterface::error, handle_, std::placeholders::_1);
  }
